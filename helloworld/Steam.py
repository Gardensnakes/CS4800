...
def google_steam(title):
    ...
    game_name = game_name.replace("®","")
    Seller = "Steam.com"
    date_scraped = _datetime.date.today()
    description = bs.find("div", {"class":"game_description_snippet"})
    ...
    # if game is not on sale
        if sub_area is not None:
            ...
            savings = 0
            game = (game_name,Seller, release_date, original_price, final, MacWin, launcher, savings, game_dev, publisher,date_scraped,description)
            ...
            game = (game_name,Seller, release_date, original, final, MacWin, launcher, savings, game_dev, publisher,date_scraped,description)
            insert_game(conn, game)
